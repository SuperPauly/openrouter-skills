...
Complete reference for integrating with [600+ AI models](https://openrouter.ai/models) through the OpenRouter Python SDK and Agent packages using the `callModel` pattern — text generation, tool use, streaming, and multi-turn conversations with a single, type-safe interface.
...
```bash
gh skill install OpenRouterTeam/skills openrouter-python-sdk
```
