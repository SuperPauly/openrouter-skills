...
description: Complete reference for integrating with OpenRouter from Python using the official openrouter package, requests, Responses API, streaming, tool calls, and model metadata.
version: 2.0.0
---
